...
struct attribute s_cube_lamp_attributes[] = {
  {"brightness", "int", NULL, offsetof(struct cube_lamp, brightness), 0, false},
  {"saturation", "int", NULL, offsetof(struct cube_lamp, saturation), 0, false},
  {"hue", "int", NULL, offsetof(struct cube_lamp, hue), 0, false},
  {"state", "bool", NULL, offsetof(struct cube_lamp, state), 1, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_round_lamp_attributes[] = {
  {"brightness", "int", NULL, offsetof(struct round_lamp, brightness), 0, false},
  {"saturation", "int", NULL, offsetof(struct round_lamp, saturation), 0, false},
  {"hue", "int", NULL, offsetof(struct round_lamp, hue), 0, false},
  {"state", "bool", NULL, offsetof(struct round_lamp, state), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};

struct apihandler_data s_apihandler_cube_lamp = {{"cube_lamp", "data", false, 0, 0, 0UL}, s_cube_lamp_attributes, sizeof(struct cube_lamp), (void (*)(void *)) glue_get_cube_lamp, (void (*)(void *)) glue_set_cube_lamp};
struct apihandler_data s_apihandler_round_lamp = {{"round_lamp", "data", false, 0, 0, 0UL}, s_round_lamp_attributes, sizeof(struct round_lamp), (void (*)(void *)) glue_get_round_lamp, (void (*)(void *)) glue_set_round_lamp};

static struct apihandler *s_apihandlers[] = {
  (struct apihandler *) &s_apihandler_cube_lamp,
  (struct apihandler *) &s_apihandler_round_lamp
};
